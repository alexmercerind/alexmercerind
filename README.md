...
Few of my popular projects are pinned below. Most projects that I've built are unique & used in a number of applications. Other than Flutter & React, I like to write native C++ Windows & Linux code (as used in my Flutter plugins & other libraries), deal with audio/video playback, reverse engineer APIs & do webscraping.
