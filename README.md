...
**My popular projects are pinned below.** Most projects that I've built are unique & used in a number of applications. Apart from Flutter & React.js, I like to reverse engineer APIs & do webscraping.
